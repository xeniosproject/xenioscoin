...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Xenios address\n"
            "  payee          - Print the masternode payout Xenios address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Xenios address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "xenios",               "masternode",             &masternode,             true,  {} },
    { "xenios",               "masternodelist",         &masternodelist,         true,  {} },
    { "xenios",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "xenios",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
