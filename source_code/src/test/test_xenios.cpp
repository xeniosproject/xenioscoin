...
#define BOOST_TEST_MODULE Xenios Test Suite

#include "test_xenios.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_xenios_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
