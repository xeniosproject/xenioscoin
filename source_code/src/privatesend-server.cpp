...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if (fLiteMode) return; // ignore all Xenios related functionality
...
/*
    ...
    allow endless transaction that would bloat Xenios and make it unusable. To
...
{
    if (fLiteMode) return;        // disable all Xenios specific functionality
