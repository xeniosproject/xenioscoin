...
from test_framework.test_framework import XeniosTestFramework
...
class LLMQCoinbaseCommitmentsTest(XeniosTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as XeniosTestFramework doesn't support this atm)
