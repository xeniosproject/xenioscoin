...
Arguments:
    <base_directory> - The base directory of a Xenios Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Xenios Core developers'
...
Arguments:
    <base_directory> - The base directory of Xenios Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Xenios Core repository.
"""
