...
This mechanism has been integrated into Bitcore-Node-Xenios which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/xeniospay/insight-api-xenios#web-socket-api](https://github.com/xeniospay/insight-api-xenios#web-socket-api)
* API: [https://github.com/xeniospay/insight-api-xenios#instantsend-transactions](https://github.com/xeniospay/insight-api-xenios#instantsend-transactions)
