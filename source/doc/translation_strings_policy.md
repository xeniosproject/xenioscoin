...
This document provides guidelines for internationalization of the Xenios Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `xenios_en.ts` remains unchanged.
