...
* xenios.conf: contains configuration settings for xeniosd or xenios-qt
* xeniosd.pid: stores the process id of xeniosd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by xeniosd or xenios-qt
